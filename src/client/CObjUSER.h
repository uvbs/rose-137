/*
	$Header: /Client/CObjUSER.h 158   06-11-27 12:14p Raning $
*/
#ifndef	__COBJUSER_H
#define	__COBJUSER_H
#include "CObjCHAR.h"
...
public:
	...
	/*override*/ float				GetCur_MOVE_SPEED ();
...
//	short							Get_WEIGHT ()				{	return	GetCur_WEIGHT ();			}
	...
	void							Set_EXP (long lValue)		{	SetCur_EXP (lValue);				}
	...
	void							Set_ITEM_UseSeparate(short nListRealNO, tagITEM& sITEM);
