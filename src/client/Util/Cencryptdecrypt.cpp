...
static unsigned char KEY[MAXKEY] = {0x34, 0x5c, 0x3d, 0x52, 0xce, 0xf3, 0x12, 0xd4, 0x05, 0x91, 0xee, 0xff, 0x49, 0xc2, 0xd2}; 
static unsigned char KEY2[3] = {0x94, 0x20, 0x5f};
static unsigned char KEY3[MAXKEY] = {0x53, 0x14, 0xf2, 0x61, 0x11, 0x54, 0xff, 0x72, 0x99, 0x44, 0xf4, 0xa1, 0xaa, 0xba, 0xc2};
...
int CEncryptDecrypt::KeyPositionInformation(std::string sKey)
{
	...
	for(i=0;i< len ; i++)
	{
		ivalue += (int)( (aTempSize[i] & 0x0f)* (int)pow(10.0f,len-(i+1)) );
	}
