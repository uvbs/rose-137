...
bool AOggSTREAM::OpenFile (char *szOGGFile, int iBufferingSec, int iBufferBlock)
{
	...
	// Garnet: The function just set the sound file to NULL and return fail on debug...let's comment it
	/**
#ifndef _DEBUG
	...
	**/
	...
	// Garnet: Code for getting sound on debug. Didn't remove the old code, may add _NOSOUND preprocessor definition later
