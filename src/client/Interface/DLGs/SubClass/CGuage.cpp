...
CGuage * CGuage::Clone()
{
	CGuage * pClone = new CGuage( m_iGuageImageID, m_iBGImageID, m_iModuleID, m_iWidth );

	pClone->m_iAutoIncrementValue		= m_iAutoIncrementValue;
	pClone->m_iAutoIncrementMaxValue	= m_iAutoIncrementMaxValue;
	pClone->m_bAutoIncrement			= m_bAutoIncrement;	
	pClone->m_iValue					= m_iValue;
	pClone->m_iHeight					= m_iHeight;
	pClone->m_iWidth					= m_iWidth;
	pClone->m_ptOffset					= m_ptOffset;
	pClone->m_strText					= GetText();
	pClone->m_ptPosition				= m_ptPosition;	
