...
protected:
	...
	bool	GetSkillIncreaseAbility_Value( int iSkillNo, int iColumn, std::string& strOut ,bool bAddTypeName );
	bool	GetSkillIncreaseAbility_Rate( int iSkillNo, int iColumn, std::string& strOut ,bool bAddTypeName );
