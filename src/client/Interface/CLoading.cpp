		...
		{			
			...
			if ( szFileName ) 
			{
				...
				if( iImageZoneNO > 13000 )
				{
					...
					m_CustomList3.insert(std::make_pair(iImageZoneNO - 10000, ivariableFirstNO));
				}
				else if( iImageZoneNO > 12000 )
				{
					m_LoadingImageTableByCustom.insert( std::make_pair< int, std::string >( iImageZoneNO - 10000,  szFileName ) );
					m_CustomList2.insert(std::make_pair(iImageZoneNO - 10000, ivariableFirstNO));
				}
				else if( iImageZoneNO > 11000 )
				{
					m_LoadingImageTableByCustom.insert( std::make_pair< int, std::string >( iImageZoneNO - 10000,  szFileName ) );
					m_CustomList1.insert(std::make_pair(iImageZoneNO - 10000, ivariableFirstNO));
				}
			}
			else
			{
