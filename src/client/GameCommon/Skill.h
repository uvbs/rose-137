/*
	$Header: /Client/gamecommon/Skill.h 25    06-03-14 10:39a Kjhpower $
*/
#ifndef	__SKILL_H
#define	__SKILL_H
...
public:
	...
	virtual void	DrawIcon( int iX, int iY, DWORD dwColor = 0xFFFFFFFF );
	virtual int		Process();
	...
	void			SetClanSkillSlot( int iSlot )	{	m_nClanSkillIndex = iSlot;	}
	int				GetClanSkillSlot(){	return m_nClanSkillIndex;	}
...
public:
	...
	/// NPC와의 거리 체크.
	static bool CheckDistanceNPC(int iskill_distance);

	/// 힐계열인지 아닌지 체크.
	static bool CheckHealType(int skillindex);
