/*
	$Header: /Client/Sound/IO_Sound.h 20    05-12-01 10:30a Raning $
*/
#ifndef	__IO_SOUND_H
#define	__IO_SOUND_H
...
#define USE_DEFAULT_3D_SOUND // To set the default 3d sound
...
public :
	...
	void SetVolume ( int iSoundVolume );

	int	 GetPan ()		{	return m_iSoundPan;	}

	// False if the file should be loaded directly.
