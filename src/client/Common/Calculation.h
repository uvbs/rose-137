...
private:
	...
	static DWORD Get_BasicDAMAGE (CObjCHAR *pATK, CObjCHAR *pDEF, WORD wHitCNT, int iSuc);
	static DWORD Get_MagicDAMAGE (CObjCHAR *pATK, CObjCHAR *pDEF, WORD wHitCNT, int iSuc);
...
public :
	...
	static DWORD Get_DAMAGE (CObjCHAR *pATK, CObjCHAR *pDEF, WORD wHitCNT);
	static DWORD Get_SkillDAMAGE (CObjCHAR *pATK, CObjCHAR *pDEF, short nSkillIDX, WORD wHitCNT);
	...
	static int  Get_SkillAdjustVALUE( CObjCHAR *pCHAR, short nSkillIDX, short nCol, int iSpellerINT, int nIngStbIDX=-1 );
