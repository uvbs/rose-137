...
public:
	...
	//조성현 2005 12 - 14 캐릭터 선택화면 Index;
	int  m_iSelectPositionIndex;           
	int  m_iMotionIDX[6];    
	int  m_iCurrentMotionState;  // 0 -> 생성후 동작, 1 -> 기본 동작, 2 -> 마우스 커서 동작, 3 -> 선택후 대기동작, 4 -> 선택후 동작, 5 -> 삭제 동작..
	bool m_bResetPositionOnOff;
