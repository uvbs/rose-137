/*
	$Header: /Client/IO_Terrain.h 104   06-08-30 3:32p Antonio $
*/
...
//	float	GetHEIGHT (float fWorldX, float fWorldY, HNODE hCheckNODE);
    ...
    void    DrawEffectAxis();    //조성현 2005 11 - 7  Debug를 위해
...
public  :
	...
	void	AddEffect(D3DVECTOR &Position, D3DXQUATERNION &Rotation, char *szEffectFile);
...
//	short	GetTileTBL(short nX, short nY)		{	return m_TileTBL.m_ppDATA[ nY ][ nX ];	}
	...
	int		GetPrevZoneNO()		{ return m_nPrevZoneNO; }
	bool    IsPVPZone();
	bool	IsAgitZone();
	...
	//조성현 2005 12 - 5 Test
    D3DXVECTOR3 m_TestEventObject[100];
    int m_nTestEventObject; 
    
    //조성현 2005 12 - 14 All Loading 추가..
	bool AllLoadingState;
	void AddMAPALL();
	void SubMAPALL();
	bool InitZONEALL (float fCenterX, float fCenterY);
