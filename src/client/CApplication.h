/*
	$Header: /Client/CApplication.h 32    06-03-31 11:07a Raning $
*/
...
//	WORD		m_wStatus;
	...
	std::string	m_strArcfourKey;
	int			m_iArcfourKeyLen;
...
//	void		SetStatus(WORD wStatus)	{	m_wStatus = wStatus;		}
	...
	void					SetArcfourKey( const char * szKey, int iKey );
	const unsigned char*	GetArcfourKey();
	int						GetArcfourKeySize();
} ;
