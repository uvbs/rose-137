/*
	$Header: /Client/IO_Effect.h 41    05-11-09 10:48a Choo0219 $
*/
...
public :
	...
	void    SetROTATION (D3DXQUATERNION &Rotation) {  ::setQuaternion( m_hRootNODEs[ 0 ], Rotation.w, Rotation.x, Rotation.y, Rotation.z); }
