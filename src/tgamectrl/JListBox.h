...
public:
	...
	///Renderer
	void	SetCellRenderer( CTListCellRenderer* pRenderer );									/// Item의 Draw가 정의된 Class를 Set
	...
	int				GetCellHeight();
private:
	CTListCellRenderer *		m_pListCellRenderer;													/// Item의 Draw가 정의된 Class
